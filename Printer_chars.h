const PChr pChars[256] = {
  ...
  {"G0 X0.9;G0 Z-2;G0 X-0.4;G0 X-0.3 Y-0.3;G0 Y-2;G0 X-0.2 Y-0.3;" \
  "G0 X0.2 Y-0.3;G0 Y-1.8;G0 X0.3 Y-0.3;G0 X0.4", 2.0f},                  //'{'
  {"G0 Z-2;G0 Y-5", 1.0f},                                                //'|'
  {"G0 Z-2;G0 X0.4;G0 X0.3 Y-0.3;G0 Y-2;G0 X0.2 Y-0.3;G0 X-0.2 Y-0.3;" \
  "G0 Y-1.8;G0 X-0.3 Y-0.3;G0 X-0.4", 2.0f},                              //'}'
